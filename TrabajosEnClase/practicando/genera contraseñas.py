...
class app:
    def __init__(self):
        ...
        if 'es_' in lang:
            self.lower_characts = string.ascii_lowercase+"ñ"
            self.upper_characts = string.ascii_uppercase+"Ñ"
        else:
            self.lower_characts = string.ascii_lowercase
            self.upper_characts = string.ascii_uppercase
    ...
    def genera_password(self):
        ...
        characts = ''
        pos = 0
        liats = [digits,self.lower_characts,self.upper_characts,special_chars]
        ...
        while self.activated == True:
            ...
            if(sum(c.islower() for c in pswrd)>=min_low
                ...
                and sum(c in special_chars for c in pswrd)>=min_chars):
